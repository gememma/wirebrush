...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".actix-http."3.3.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      actix_codec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".actix-codec."0.5.1" { inherit profileName; };
      ...
      tokio_util = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-util."0.7.8" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
      zstd = rustPackages."registry+https://github.com/rust-lang/crates.io-index".zstd."0.12.4" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".actix-router."0.5.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.175" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.37" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".actix-web."4.3.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.11.0" { inherit profileName; };
      socket2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".socket2."0.4.9" { inherit profileName; };
      time = rustPackages."registry+https://github.com/rust-lang/crates.io-index".time."0.3.23" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".grass."0.12.4" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      grass_compiler = rustPackages."registry+https://github.com/rust-lang/crates.io-index".grass_compiler."0.12.4" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".grass_compiler."0.12.4" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      codemap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".codemap."0.1.3" { inherit profileName; };
      indexmap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."1.9.3" { inherit profileName; };
      lasso = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lasso."0.6.0" { inherit profileName; };
      once_cell = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.18.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".maud."0.25.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      actix_web_dep = rustPackages."registry+https://github.com/rust-lang/crates.io-index".actix-web."4.3.1" { inherit profileName; };
      futures_util = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.28" { inherit profileName; };
      itoa = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itoa."1.0.9" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".time."0.3.23" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      time_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".time-macros."0.2.10" { profileName = "__noProfile"; };
    };
  });
  ...
  "unknown".wirebrush."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      grass = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".grass."0.12.4" { profileName = "__noProfile"; };
    };
  });
